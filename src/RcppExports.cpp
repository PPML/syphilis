...
List syphSimCTCounterfactual(List x, double dt, List cm, NumericVector pabx, NumericVector rep_count, int nYrs, NumericVector initPop, NumericVector n_sa, arma::mat births, arma::mat births_sa, arma::mat births_nsa, arma::mat aging, arma::mat aging_nsa);
RcppExport SEXP _syphilis_syphSimCTCounterfactual(SEXP xSEXP, SEXP dtSEXP, SEXP cmSEXP, SEXP pabxSEXP, SEXP rep_countSEXP, SEXP nYrsSEXP, SEXP initPopSEXP, SEXP n_saSEXP, SEXP birthsSEXP, SEXP births_saSEXP, SEXP births_nsaSEXP, SEXP agingSEXP, SEXP aging_nsaSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< List >::type x(xSEXP);
    ...
    Rcpp::traits::input_parameter< arma::mat >::type aging(agingSEXP);
    Rcpp::traits::input_parameter< arma::mat >::type aging_nsa(aging_nsaSEXP);
    rcpp_result_gen = Rcpp::wrap(syphSimCTCounterfactual(x, dt, cm, pabx, rep_count, nYrs, initPop, n_sa, births, births_sa, births_nsa, aging, aging_nsa));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_syphilis_syphSimCTCounterfactual", (DL_FUNC) &_syphilis_syphSimCTCounterfactual, 13},
    {NULL, NULL, 0}
};
