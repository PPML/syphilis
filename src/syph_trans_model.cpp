...
List syphSim(
  ...
  NumericVector c_hetero = as<NumericVector>(x["behav.hetero"]); //transmission rr in heterosexuals
    ...
    for(int w=0; w<52; w++){
			...
			/* for (int d=0; d<7; d++){ */
				...
				for(int n=0; n<4; n++) { //males subpop 1
					int m = n;
					lambda[n] =  ((b[0] + (1-b[0])*c_rr_hetero) * (cmlow1[m]     * (I1[20] + I2[20] + IR1[20] + IR2[20]) / (n_sa[20]) + //F, low AC, age=1, subpop1
				...
				for(int n=4; n<8; n++) {   //males subpop 2
					int m = n-4;
					lambda[n] =  ((b[0] + (1-b[0])*c_rr_hetero) * (cmlow2[m]     * (I1[20] + I2[20] + IR1[20] + IR2[20]) / (n_sa[20]) + //F, low AC, age=1, subpop1
				...
				for(int n=8; n<12; n++) {   //males subpop 3
					int m = n-8;
					lambda[n] =  ((b[0] + (1-b[0])*c_rr_hetero) * (cmlow3[m]     * (I1[20] + I2[20] + IR1[20] + IR2[20]) / (n_sa[20]) + //F, low AC, age=1, subpop1
				...
				for(int n=12; n<16; n++) {   //males subpop 4
					int m = n-12;
					lambda[n] =  (((b[0] + (1-b[0])*c_rr_hetero) *  (cmlow4[m]     * (I1[20] + I2[20] + IR1[20] + IR2[20]) / (n_sa[20]) + //F, low AC, age=1, subpop1
				...
				for(int n=16; n<20; n++) {   //males subpop 5
					int m = n-16;
					lambda[n] =  (((b[0] + (1-b[0])*c_rr_hetero) *(cmlow5[m]     * (I1[20] + I2[20] + IR1[20] + IR2[20]) / (n_sa[20]) + //F, low AC, age=1, subpop1
				...
				for(int n=20; n<24; n++) {   //females subpop 1
					int m = n;
					lambda[n] =  ((b[1] + (1-b[1])*c_rr_hetero) * (cmlow1[m+20]     * (I1[0]  + I2[0]  + IR1[0]  + IR2[0])  /(n_sa[0])  + //M, low AC, age=1, subpop1
				...
				for(int n=24; n<28; n++) {   //females subpop 2
					int m = n-4;
					lambda[n] =  ((b[1] + (1-b[1])*c_rr_hetero) * (cmlow2[m+20]     * (I1[0]  + I2[0]  + IR1[0]  + IR2[0])  / (n_sa[0])  + //M, low AC, age=1, subpop1
				...
				for(int n=28; n<32; n++) {   //females subpop 3
					int m = n-8;
					lambda[n] =  ((b[1] + (1-b[1])*c_rr_hetero) * (cmlow3[m+20]    * (I1[0]   + I2[0]  + IR1[0]  + IR2[0])  / (n_sa[0])  + //M, low AC, age=1, subpop1
...
/*   /1* for(int m=0; m<nYrs; m++) { *1/ */
/*   /1*   for(int n=0; n<dim*24+1; n++) { *1/ */
/*   /1*     out(m,n) = outputs(m,n); *1/ */
/*   /1*   } *1/ */
/*   /1* } *1/ */
